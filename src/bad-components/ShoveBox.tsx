...
function ShoveBoxButton({
    ...
    return (
        <Button
            onClick={() => {
                setPosition(position + 4); // Increment position correctly
            }}
        >
            Shove the Box
        </Button>
    ...
    return (
        <div
            ...
            style={{
                ...
                marginLeft: `${position}px`, // Properly format marginLeft
            }}
        ></div>
    );
}
...
export function ShoveBox(): React.JSX.Element {
    const [position, setPosition] = useState<number>(10); // Lift state up
